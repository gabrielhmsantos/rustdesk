...
class MyTheme {
  ...
  static const Color accent = Color(0xFFeb5f0a);
  static const Color accent50 = Color(0x77eb5f0a);
  static const Color accent80 = Color(0xAAeb5f0a);
  ...
  static const Color button = Color(0xFFff4500);
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing InfoMaster...");
...
Widget loadPowered(BuildContext context) {
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://infomaster.inf.br'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(

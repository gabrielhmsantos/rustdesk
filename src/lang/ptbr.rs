...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "RaksaDesk - \"O Poder do Controle em Suas Mãos\""),
        ...
        ("Collapse toolbar", "Recolher Toolbar"),
        ...
        ("Reverse mouse wheel", "Roda do mouse reversa"),
        ("{} sessions", "{} sessões"),
        ("scam_title", ""),
        ("scam_text1", ""),
        ("scam_text2", ""),
        ...
        ("Timeout in minutes", "Timeout em minutos"),
        ("auto_disconnect_option_tip", "Fechar automaticamente sessões recebidas por inatividade do usuário"),
        ("Connection failed due to inactivity", "Conexão falhou devido à inatividade"),
        ...
        ("No displays", "Nenhuma exibição"),
        ("elevated_switch_display_msg", ""),
        ("Open in new window", "Abrir em nova janela"),
        ("Show displays as individual windows", "Exibir telas em janelas individuais"),
        ("Use all my displays for the remote session", "Usar todas as telas para a sessão remota"),
        ("selinux_tip", ""),
        ...
        ("Plug out all", ""),
        ("True color (4:4:4)", ""),
        ("Enable blocking user input", "Habilitar bloqueio de entrada do usuário"),
        ("id_input_tip", "Você pode inserir um ID, um IP direto ou um domínio com uma porta (<domínio>:<porta>).\nSe desejar acessar um dispositivo em outro servidor, anexe o endereço do servidor (<id>@<endereço_servidor >?key=<key_value>), por exemplo,\n9123456234@192.168.16.1:21117?key=PublicKey=.\nSe você deseja acessar um dispositivo em um servidor público, insira \"<id>@public\" , a chave não é necessária para servidor público"),
        ...
        ("swap-left-right-mouse", "Inverter botões do mouse"),
        ("2FA code", "Código 2FA"),
        ("More", ""),
        ("enable-2fa-title", ""),
        ("enable-2fa-desc", ""),
        ...
        ("Follow remote window focus", "Seguir a janela remota ativa"),
        ("default_proxy_tip", ""),
